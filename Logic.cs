...
namespace PokemonGo.RocketAPI.Logic
{
    ...
    public class Logic
    {
        ...
        public static double getAlt()
        {
            try
            {
                return _client.CurrentAltitude;
    }
            catch (Exception ex)
            {
                return 0.0;
        ...
        private async Task StatsLog(Client client)
        {
            ...
            Logger.ColoredConsoleWrite(ConsoleColor.Cyan, "Location: " + _client.CurrentLat + "," + _client.CurrentLng);
            lon = "";
