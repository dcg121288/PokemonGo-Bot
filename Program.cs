            ...
            else
            {
                ...
                if (Globals.pokeList)
                {
                    Task.Run(() =>
                    {
                        ...
                        LocationSelect mapa = new LocationSelect();
                        mapa.button1.Enabled = false;
                        mapa.textBox1.Enabled = false;
                        mapa.textBox2.Enabled = false;
                        mapa.textBox3.Enabled = false;
                        //mapa.map.Enabled = false;
                        mapa.timer1.Enabled = true;
                        mapa.ShowDialog();
